class ElementVariablePreciosController < ApplicationController
  ...
  def index
    @element_variable_precios = ElementVariablePrecio.all
  ...
  def show
    @element_variable_precio = ElementVariablePrecio.find(params[:id])
  ...
  def new
    @element_variable_precio = ElementVariablePrecio.new
  ...
  def create
    @element_variable_precio = ElementVariablePrecio.new(params[:element_variable_precio])

    respond_to do |format|
      if @element_variable_precio.save
        format.html { redirect_to(@element_variable_precio, :notice => 'Element variable precio was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @element_variable_precio.update_attributes(params[:element_variable_precio])
        format.html { redirect_to(@element_variable_precio, :notice => 'Element variable precio was successfully updated.') }
        format.xml  { head :ok }
      else
